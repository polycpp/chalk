...
chalk targets C++20 and builds with clang ≥ 14 or gcc ≥ 11. It depends
...
If you already have chalk and polycpp checked out side by side, tell
...
.. code-block:: bash
   ...
   cmake -B build -G Ninja \
       ...
       -DFETCHCONTENT_SOURCE_DIR_POLYCPP_CHALK=/path/to/chalk
...
issue on the `repository <https://github.com/polycpp/chalk/issues>`_
